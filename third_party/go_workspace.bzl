...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:Y7pyy1viWfoKMUVxmjfI5X6fVLlen75kdYjeIwl9CKc=",
        version = "v2.10.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Cnc4NxIySph38pQPzKbjg5OkKsGR/Cf5xcWt5OlSUDI=",
        version = "v1.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BFhFnElL3HVa/e1sXTogmKbMlY2HgfEP1fozVc6/eYA=",
        version = "v2.0.1",
    )
    go_repository(
